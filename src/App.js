      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-gray-300 bg-gray-700">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <button
            ...
            className="outline-none text-white bg-blue-700 px-2 py-2 shrink-0"
          >
            copy
          </button>
        </div>
        ...
        <div className="text-center">
          <button
            ...
            className="outline-none text-sm text-center hover:bg-blue-800 rounded-lg text-white bg-blue-700 px-2 py-2 shrink-0"
          >
            Genrator
          </button>
        </div>
